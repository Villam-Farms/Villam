    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.actions}>
          {back && <Pressable accessibilityRole="button" hitSlop={8} style={[styles.routeButton, styles.back]} onPress={goBack}><Text style={styles.backText}>Back</Text></Pressable>}
          <Pressable accessibilityRole="button" hitSlop={8} disabled={disabled} onPress={goNext} style={({ pressed }) => [styles.routeButton, styles.next, pressed && styles.pressed, disabled && styles.disabled]}>
